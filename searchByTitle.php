...
<div class="columnsContainer">
	  	...
	  	<div class="leftColumn">
			...
			<table align="center">
				<tr>
					<td colspan="2" align="center"><h2>Search Thesis By Title</h2></td>
				</tr>
				<tr>
					<td>Select one</td>
					<td>
					<select name="thesis" id="thesis" style="width:auto" onChange="displayThesis()">
						...
						<option value="<?php echo $res[$i]['id']; ?>"><?php echo $res[$i]['title']; ?></option>
						<?php } ?>
					</select>
					</td>
				</tr>
	...
	function displayThesis(){
		...
		if(id=='')
		{
			...
			window.location.href='searchByTitle.php?tid='+id;
		}
	}
	</script>	
